...
close all
clc
pntaps = [0 1 1 1 0 0 0 1];         % shift register taps
pninitial = [0 0 0 0 0 0 0 1 ];      % initial shift register state
pndata = zeros(1,255);             % initialize output vector
...
while kk == 0
   ...
   pnregister = [feedback,pnregister(1,1:7)];   % increment register
